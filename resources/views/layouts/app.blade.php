    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #eef4ed;">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                ...
                <a class="nav-item nav-link mx-3 {{ request()->is('bio') ? 'active' : '' }}" href="{{ route('bio') }}">Bio</a>
                <a class="nav-item nav-link mx-3 {{ request()->is('about') ? 'active' : '' }}" href="{{ route('about') }}">About</a>
                <a class="nav-item nav-link mx-3 {{ request()->is('contact') ? 'active' : '' }}" href="{{ route('contact') }}">Contact</a>
            </div>
        </div>
    </nav>
    <div>
    ...
    <div class="row">
            ...
            <div class="col-md-6">
                ...
                <ul class="social-media">
                    <li><a href="https://www.facebook.com" class="social-link"><i class="fab fa-facebook-f"></i></a></li>
