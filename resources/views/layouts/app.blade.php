...
<body>
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #D4D1CB;">
        <a class="navbar-brand navbar-brand-orange" href="#" style="color:#AB372E; font-weight: bold;">Shraddha
        </a>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                ...
                <a class="nav-item nav-link mx-3 {{ request()->is('posts') ? 'active' : '' }}"
    ...
    <footer class="footer text-center text-white">
        ...
        <div class="container">
            ...
            <section class="mb-3">
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-8">
                        ...
                        <h6>Email: {{ optional($detail)->email }}</h6>
                        <h6>Contact: {{ optional($detail)->number }}</h6>
                    </div>
                </div>
            </section>
            <!-- Section: Text -->
            ...
            <section class="text-center mb-3">
                <a href="{{ optional($detail)->facebook }}" class="text-white me-4">
                    <i class="fab fa-facebook-f"></i>
                </a>
                <a href="{{ optional($detail)->instagram }}" class="text-white me-4">
                    <i class="fab fa-instagram"></i>
                </a>
                <a href="{{ optional($detail)->youtube }}" class="text-white me-4">
